...
export default function Modal({ modal, setModal}) {
  ...
  return (
    <div className={`${modal.showModal ? "absolute z-10 w-full flex items-center justify-center" : "hidden"}`}>
      <div className="absolute z-10 flex w-full flex-col p-10 rounded-md items-center bg-white border-[1px] border-black shadow-md shadow-black space-y-10 md:w-1/4 justify-center">
        ...
        <button
          ...
          className={`py-2 px-8 ${modal.type === "SUCCESS"?"bg-green-700":"bg-red-700"} text-white rounded-md`}
        >
          {modal.buttonText}
        </button>
      </div>
